...
using TestTemplate3.Common.MessageBroker.Middlewares.ErrorLogging;
using TestTemplate3.Common.MessageBroker.Middlewares.Tracing;
using TestTemplate3.Core;
using TestTemplate3.Core.Events;
using TestTemplate3.Data;
using TestTemplate3.WorkerServices.FaultService;
using TestTemplate3.WorkerServices.FooService;
using LoggerExtensions = SparkRoseDigital.Infrastructure.Logging.LoggerExtensions;

namespace TestTemplate3.WorkerServices
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                Log.Information("Starting up TestTemplate3 Worker Services.");
            ...
            {
                Log.Fatal(ex, "TestTemplate3 Worker Services failed at startup.");
            }
            finally
            {
                Log.CloseAndFlush();
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    {
                        var connString = new SqlConnectionStringBuilder(configuration.GetConnectionString("TestTemplate3DbConnection"))
                        {
