...
using TestTemplate3.Api.Helpers;
using TestTemplate3.Api.Middlewares;
using TestTemplate3.Application;
using TestTemplate3.Common.MessageBroker;
using TestTemplate3.Core;
...
namespace TestTemplate3.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TestTemplate3DbContext>(options =>
            {
                var connString = new SqlConnectionStringBuilder(_configuration.GetConnectionString("TestTemplate3DbConnection") ?? string.Empty)
                {
            ...
            services.AddSwaggerGen(setupAction =>
            {
                setupAction.SwaggerDoc(
                    "TestTemplate3OpenAPISpecification",
                    new OpenApiInfo
                    {
                        Title = "TestTemplate3 API",
                        Version = "v1",
                        Description = "This API allows access to TestTemplate3.",
                ...
                setupAction.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestTemplate3.Api.xml"));
            });
            ...
            services.AddCors(o => o.AddPolicy("TestTemplate3Client", builder =>
            {
            ...
            services.AddMassTransit(x =>
            {
                ...
                x.AddEntityFrameworkOutbox<TestTemplate3DbContext>(o =>
                {
            ...
            services.AddTestTemplate3ApplicationHandlers();
            ...
            services
                .AddHealthChecks()
                .AddDbContextCheck<TestTemplate3DbContext>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //    app.UseHsts();
            // }
            app.UseCors("TestTemplate3Client");
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/TestTemplate3OpenAPISpecification/swagger.json", "TestTemplate3 API");
