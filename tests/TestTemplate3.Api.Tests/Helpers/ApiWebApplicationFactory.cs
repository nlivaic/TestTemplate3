        ...
        IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                services.Remove(services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<TestTemplate3DbContext>)));
                ...
                var ctx = scopedServices.GetRequiredService<TestTemplate3DbContext>();
        ...
        public TestTemplate3DbContext CreateDbContext(ITestOutputHelper testOutput = null)
        {
        ...
        {
            private readonly DbContextOptions<TestTemplate3DbContext> _options;
            ...
            {
                _options = new DbContextOptionsBuilder<TestTemplate3DbContext>()
            ...
            public TestTemplate3DbContext BuildContext() =>
                new(_options);
        }
    }
}
